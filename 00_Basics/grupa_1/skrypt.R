...
oferty_informacje <- read.csv('/pobranie_danych/oferty_informacje.csv', encoding = "UTF-8")
...
dim(filter(oferty_informacje_low, !zapietki_wkladki))
...
marka2 <- distinct(oferty_informacje_low, marka)
